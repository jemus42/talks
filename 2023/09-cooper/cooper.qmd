...
Feature-weighted elastic net [^1] extends the objective function:
...
[^1]: @tay2023featureweightedelastic
...
1.  Initialize $\symbf{\beta_1}^{(0)}, \symbf{\beta_2}^{(0)}$ to elastic net solution for $(\mathbf{X}, \mathbf{y}_1), (\mathbf{X}, \mathbf{y}_2)$ respectively
