...
-   Goal: Fast, flexible, and **interpretable** predictive models
...
- Prediction built up incrementally, guided by residuals (cf. Gradient Boosting)
...
- (↓) Computationally heavy for large data (implementation not fully optimized, WIP!)
