...
$$\begin{align}
\lambda(t) &:= \lim_{\Delta t \to 0} \frac{\mathrm{Pr}(t \leq T < \Delta t\ |\ T \geq t)}{\Delta t}
\end{align}$$
...
$$
f(t) = \lambda(t) \exp\left(-\int_0^t \lambda(u) \mathrm{d}u\right)
$$
...Which lets us construct a Likelihood
