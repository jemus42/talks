...
- Procedure:
    ...
    3. Minimize Poisson likelihood with algorithm of choice (e.g. GAM, Boosting)
...
- 2) PAM: Expand PAM to GAM framework, gain flexible effects 
...
- 4) DeepPAM = SDDR + PAM
  - Minimize Poisson likelihood through DL
  - Incorporate unstructured data (e.g. images)
